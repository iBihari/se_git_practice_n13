...
import com.shubhamgupta16.simplewallpaper.dialogs.DialogWallFromUrl;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionButton = findViewById(R.id.fromUrl);
        actionButton.setOnClickListener(view -> {
            DialogWallFromUrl dialogWallFromUrl = new DialogWallFromUrl();
            dialogWallFromUrl.show(getSupportFragmentManager(), "DialogImage");
        });
